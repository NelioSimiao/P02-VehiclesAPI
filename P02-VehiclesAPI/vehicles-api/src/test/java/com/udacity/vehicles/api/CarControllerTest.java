...
public class CarControllerTest {
    ...
    public void setup() {
        ...
        given(priceClient.getPrice(any())).willReturn(String.valueOf(price));
    ...
    @Test
    public void testPriceServiceClient() throws Exception {
        String priceClientResul = priceClient.getPrice(1L);
        Assert.assertNotNull(priceClientResul);
    }

    @Test
    public void testMapsClient() throws Exception {
        Car car = getCar();
        Assert.assertNull(mapsClient.getAddress(car.getLocation()));
    }
